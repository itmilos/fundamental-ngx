...
/**
 * Created to have all the previous implementation of the TableCellDirective because it's deprecated now in favour of TableCellComponent.
 * To be removed once we remove TableCellDirective and code to be moved to the TableCellComponent.
 */
@Directive()
export class TableCell implements AfterContentInit, OnDestroy {
